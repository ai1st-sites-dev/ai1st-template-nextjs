      ...
      <section className="section-padding" aria-labelledby="timeline-heading">
        <div className="container-width">
          ...
          <div className="mt-16 overflow-x-auto">
            <div className="relative flex items-start gap-0" style={{ minWidth: `${data.events.length * 200}px` }}>
        ...
        <div className="container-width">
          ...
          <div className="mx-auto mt-12 max-w-3xl">
            {data.events.map((event, index) => (
              <div
                key={index}
                className={`flex items-start gap-6 py-6 ${index < data.events.length - 1 ? 'border-b border-gray-200' : ''}`}
              >
